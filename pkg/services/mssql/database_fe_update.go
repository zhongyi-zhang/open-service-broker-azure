...
func (d *databaseFeManager) ValidateUpdatingParameters(
...
func (d *databaseFeManager) GetUpdater(service.Plan) (service.Updater, error) {
...
func (d *databaseFeManager) updateARMTemplate(
	_ context.Context,
	instance service.Instance,
