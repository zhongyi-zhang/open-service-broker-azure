	...
	return service.NewCatalog([]service.Service{
		...
		service.NewService(
			service.ServiceProperties{
				...
				Bindable: false,
				Tags:     []string{"Azure", "SQL", "DBMS", "Server", "DR", "disaster recovery", "failover group"},
				Extended: map[string]interface{}{
					"version": "12.0",
				},
			},
		...
		service.NewService(
			service.ServiceProperties{
				...
				Tags: []string{"Azure", "SQL", "Database", "DR", "disaster recovery", "failover group"},
				Extended: map[string]interface{}{
					"version": "12.0",
				},
			},
		...
		service.NewService(
			...
			m.databasePairFePrimaryManager,
			service.NewPlan(
				buildBasicPlan(
