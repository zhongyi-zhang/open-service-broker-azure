...
func (d *databasePairManager) ValidateUpdatingParameters(
...
func (d *databasePairManager) GetUpdater(
	service.Plan,
...
func (d *databasePairManager) updatePriARMTemplate(
	_ context.Context,
	instance service.Instance,
...
func (d *databasePairManager) updateSecARMTemplate(
	_ context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
	dt := instance.Details.(*databasePairInstanceDetails)
