...
func (d *databasePairFeManager) GetDeprovisioner(
	service.Plan,
...
func (d *databasePairFeManager) deletePriARMDeployment(
	_ context.Context,
...
func (d *databasePairFeManager) deleteSecARMDeployment(
	_ context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
	dt := instance.Details.(*databasePairInstanceDetails)
...
func (d *databasePairFeManager) deleteFgARMDeployment(
	_ context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
	dt := instance.Details.(*databasePairInstanceDetails)
...
func (d *databasePairFeManager) deletePriDatabase(
	ctx context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
...
func (d *databasePairFeManager) deleteSecDatabase(
	ctx context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
	ctx, cancel := context.WithCancel(ctx)
...
func (d *databasePairFeManager) deleteFailoverGroup(
	ctx context.Context,
	instance service.Instance,
) (service.InstanceDetails, error) {
	ctx, cancel := context.WithCancel(ctx)
